...
public class Coords : MonoBehaviour
{
    ...
    static public void DrawPoint(Coords position, float width, Color colour)
    {
        ...
        // Attach line renderer component to the line gameobject
        // A line renderer is a component that is put into a gameobject and use it to draw a line in 3D space
    ...
    {
        GameObject line = new GameObject("Line_" + startPos.ToString() + endPos.ToString());
        // Attach line renderer component to the line gameobject
        // A line renderer is a component that is put into a gameobject and use it to draw a line in 3D space
        LineRenderer lineRenderer = line.AddComponent<LineRenderer>();
        lineRenderer.material = new Material(Shader.Find("Unlit/Color"));
